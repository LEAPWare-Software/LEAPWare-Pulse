...
Usage:
    python scripts/lwp_apply_rulesets.py                 # apply every ruleset
    python scripts/lwp_apply_rulesets.py --dry-run        # print the JSON, do nothing
    python scripts/lwp_apply_rulesets.py --repo OWNER/REPO --dry-run
...
that fixes it, and applies nothing.
"""
...
DEFAULT_REPO = "LEAPWare-Software/LEAPWare-Pulse"
